...
---
**Disclaimer:** This content is AI-generated and strictly for informational purposes. It is not a medical diagnosis. Consult a professional physician.`;
    };
                            ...
                            >
                                {currentSession?.messages.length === 0 && (
                                    <div className="h-full flex flex-col items-center justify-center text-center opacity-50 px-8">
                                        ...
                                        <p className="mb-4">Select symptoms from the dashboard<br />or describe how you feel.</p>
                                        <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-3 max-w-sm">
                                            <p className="text-xs text-yellow-500/80 leading-relaxed font-medium">
                                                Preliminary AI Diagnosis Only
                                            </p>
                                            <p className="text-[10px] text-yellow-500/60 mt-1 leading-normal">
